...
set "L_DISCOUNT" = "L_DISCOUNT" * 1.3
;

update "lineitems_dedupe_10pct"
set "L_DISCOUNT" = "L_DISCOUNT" * 1.1
;

update "lineitems_dedupe"
set "L_DISCOUNT" = "L_DISCOUNT" * 1.2
;
...
-- upserting   15.000.000 (all rows are new)
-- large:  42s

-- final rows 150.000.000
-- upserting    1.500.000 (all rows are new)
-- large:  31s

-- final rows 150.000.000
-- upserting      150.000 (all rows are new)
-- large:  30.5s
