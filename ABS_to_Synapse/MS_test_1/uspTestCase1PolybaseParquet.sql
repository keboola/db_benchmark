alter proc TestCase1PolybaseParquet
	@DWU int,
...
(
    ...
    FILE_FORMAT = KeboolaParquetSnappyFormat
) ;
...
/*
exec TestCase1PolybaseParquet @DWU=500, @ResourceClass='largerc', @scalefactor=1, @files=60, @folder='Parquet', @compression='gzip'
exec TestCase1PolybaseParquet @DWU=500, @ResourceClass='largerc', @scalefactor=1, @files=60, @folder='Parquet', @compression='none'
*/
