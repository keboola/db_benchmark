...
--exec TestCase1CopyCSV @DWU=0, @ResourceClass='largerc', @scalefactor=1, @files=100, @folder='CSV', @compression='gzip'
--exec TestCase1CopyCSV @DWU=0, @ResourceClass='largerc', @scalefactor=10, @files=100, @folder='CSV', @compression='gzip'
--exec TestCase1CopyCSV @DWU=0, @ResourceClass='largerc', @scalefactor=100, @files=100, @folder='CSV', @compression='gzip'
/*
exec TestCase1CopyCSV @DWU=500, @ResourceClass='largerc', @scalefactor=1, @files=60, @folder='CSV', @compression='gzip'
exec TestCase1CopyCSV @DWU=500, @ResourceClass='largerc', @scalefactor=1, @files=60, @folder='CSV', @compression='none'
*/
